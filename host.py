...
def get_num_pages(page):
    ...
    str_reviews = tab.nth(1).text_content(
    ) if tab.count() > 1 else tab.text_content()
...
def get_all_reviews(page):
    ...
    host_reviews = page.locator(
        'div#panel--user-profile-review-tabs--0 div._1v365y9') if tabs.count() > 1 else page.locator('div._1v365y9')
